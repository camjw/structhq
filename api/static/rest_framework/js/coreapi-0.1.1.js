  ...
  })(
    {
      1: [
        function (require, module, exports) {
          ...
          var _createClass = (function () {
            ...
            return function (Constructhqor, protoProps, staticProps) {
              if (protoProps)
                defineProperties(Constructhqor.prototype, protoProps);
              if (staticProps) defineProperties(Constructhqor, staticProps);
              return Constructhqor;
            };
          })();

          function _classCallCheck(instance, Constructhqor) {
            if (!(instance instanceof Constructhqor)) {
      ...
      11: [
        function (require, module, exports) {
          ...
          function _possibleConstructhqorReturn(self, call) {
            if (!self) {
          ...
          var ParameterError = (function (_Error) {
            ...
            function ParameterError(message) {
              ...
              var _this = _possibleConstructhqorReturn(
                this,
                (
          ...
          var LinkLookupError = (function (_Error2) {
            ...
            function LinkLookupError(message) {
              ...
              var _this2 = _possibleConstructhqorReturn(
                this,
                (
          ...
          var ErrorMessage = (function (_Error3) {
            ...
            function ErrorMessage(message, content) {
              ...
              var _this3 = _possibleConstructhqorReturn(
                this,
                (
      ...
      19: [
        function (require, module, exports) {
           ...
           * create an actual constructhqor as it's much more memory efficient and
          ...
          function URL(address, location, parser) {
            ...
            //
            // Extract protocol information before running the instructhqions.
            //
            ...
            // component.
            //
            if (!extracted.slashes) instructhqions[2] = [/(.*)/, "pathname"];

            for (; i < instructhqions.length; i++) {
              instructhqion = instructhqions[i];
              parse = instructhqion[0];
              key = instructhqion[1];
              ...
              if (parse !== parse) {
                ...
                if (~(index = address.indexOf(parse))) {
                  if ("number" === typeof instructhqion[2]) {
                    url[key] = address.slice(0, index);
                    address = address.slice(index + instructhqion[2]);
                  } else {
              ...
              url[key] =
                url[key] ||
                (relative && instructhqion[3] ? location[key] || "" : "");

              //
              // Hostname, host and protocol should be lowercased so they can be used to
              // create a proper `origin`.
              //
              if (instructhqion[4]) url[key] = url[key].toLowerCase();
            }
            ...
            if (url.auth) {
              instructhqion = url.auth.split(":");
              url.username = instructhqion[0] || "";
              url.password = instructhqion[1] || "";
            }
      ...
      22: [
        function (require, module, exports) {
          (function (self) {
            ...
            // Build a destructhqive iterator for the value list
