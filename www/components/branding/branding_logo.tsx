...
import { COMPANY_LOGO_SVG, COMPANY_NAME } from "@/lib/constants";
  ...
  "rounded-full items-center justify-center flex ring-1 ring-transparent flex-shrink-0",
  {
    variants: {
      size: {
        ...
        lg: "w-[56px] h-[56px] sm:w-[92px] sm:h-[92px]",
      },
    },
    defaultVariants: {
      size: "default",
...
export function BrandingLogoType({ size, className }: BrandingLogoProps) {
  return (
    <div className="flex flex-row items-center gap-2">
      ...
      <h3
        className={cn(
          "text-3xl tracking-tight font-display font-semibold text-black"
        )}
      >
        {COMPANY_NAME}
      </h3>
