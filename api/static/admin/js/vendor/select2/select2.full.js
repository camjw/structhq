  ...
  var S2 = (function () {
    ...
    S2.define("select2/utils", ["jquery"], function ($) {
      ...
      Utils.Extend = function (ChildClass, SuperClass) {
        ...
        function BaseConstructhqor() {
          this.constructhqor = ChildClass;
        }
        ...
        BaseConstructhqor.prototype = SuperClass.prototype;
        ChildClass.prototype = new BaseConstructhqor();
      ...
      Utils.Decorate = function (SuperClass, DecoratorClass) {
        ...
        function DecoratedClass() {
          ...
          var argCount = DecoratorClass.prototype.constructhqor.length;

          var calledConstructhqor = SuperClass.prototype.constructhqor;

          if (argCount > 0) {
            unshift.call(arguments, SuperClass.prototype.constructhqor);

            calledConstructhqor = DecoratorClass.prototype.constructhqor;
          }

          calledConstructhqor.apply(this, arguments);
        }

        DecoratorClass.displayName = SuperClass.displayName;

        function ctr() {
          this.constructhqor = DecoratedClass;
        }
    ...
    S2.define("select2/results", ["jquery", "./utils"], function ($, Utils) {
      function Results($element, options, dataAdapter) {
        ...
        Results.__super__.constructhqor.call(this);
      }
    ...
    S2.define(
      ...
      function ($, Utils, KEYS) {
        function BaseSelection($element, options) {
          ...
          BaseSelection.__super__.constructhqor.call(this);
        }
    ...
    S2.define(
      ...
      function ($, BaseSelection, Utils, KEYS) {
        function SingleSelection() {
          SingleSelection.__super__.constructhqor.apply(this, arguments);
        }
    ...
    S2.define(
      ...
      function ($, BaseSelection, Utils) {
        function MultipleSelection($element, options) {
          MultipleSelection.__super__.constructhqor.apply(this, arguments);
        }
    ...
    S2.define("select2/data/base", ["../utils"], function (Utils) {
      function BaseAdapter($element, options) {
        BaseAdapter.__super__.constructhqor.call(this);
      }
    ...
    S2.define(
      ...
      function (BaseAdapter, Utils, $) {
        function SelectAdapter($element, options) {
          ...
          SelectAdapter.__super__.constructhqor.call(this);
        }
    ...
    S2.define(
      ...
      function (SelectAdapter, Utils, $) {
        function ArrayAdapter($element, options) {
          ...
          ArrayAdapter.__super__.constructhqor.call(this, $element, options);
        }
    ...
    S2.define(
      ...
      function (ArrayAdapter, Utils, $) {
        function AjaxAdapter($element, options) {
          ...
          AjaxAdapter.__super__.constructhqor.call(this, $element, options);
        }
    ...
    S2.define("select2/dropdown", ["jquery", "./utils"], function ($, Utils) {
      function Dropdown($element, options) {
        ...
        Dropdown.__super__.constructhqor.call(this);
      }
    ...
    S2.define(
      ...
      function ($, Options, Utils, KEYS) {
        var Select2 = function ($element, options) {
          ...
          Select2.__super__.constructhqor.call(this);
