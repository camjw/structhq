!(function (c) {
  ...
  var e = function (h, g) {
    ...
    this.formatType =
      g.formatType || this.element.data("format-type") || "standard";
    this.format = b.parseFormat(
      g.format ||
        this.element.data("date-format") ||
        d[this.language].format ||
    ...
    this.componentReset = this.element.is(".date")
      ? this.bootcssVer == 3
        ? this.element.find(".input-group-addon .glyphicon-remove").parent()
    ...
    this.pickerPosition =
      ...
      "bottom-right";
    this.showMeridian =
      g.showMeridian || this.element.data("show-meridian") || false;
    ...
    if ("wheelViewModeNavigationInverseDirection" in g) {
      this.wheelViewModeNavigationInverseDirection =
        g.wheelViewModeNavigationInverseDirection;
    } else {
    ...
    this.todayHighlight =
      g.todayHighlight || this.element.data("date-today-highlight") || false;
    this.weekStart =
      (g.weekStart ||
        this.element.data("date-weekstart") ||
        d[this.language].weekStart ||
        0) % 7;
    ...
    this.setDaysOfWeekDisabled(
      g.daysOfWeekDisabled || this.element.data("date-days-of-week-disabled")
    );
    this.fillDow();
    this.fillMonths();
    this.update();
  ...
  e.prototype = {
    ...
    fill: function () {
      ...
      this.picker
        ...
        .text(d[this.language].months[F] + " " + q);
      ...
      for (var x = 0; x < 24; x++) {
        ...
        r = "";
        if (
          t.valueOf() + 3600000 <= this.startDate ||
      ...
      for (var x = 0; x < 60; x += this.minuteStep) {
        ...
        if (t.valueOf() < this.startDate || t.valueOf() > this.endDate) {
          ...
          if (
            Math.floor(u / this.minuteStep) == Math.floor(x / this.minuteStep)
          ) {
            r += " active";
          }
        }
                ...
                if (l.is(".year")) {
                  ...
                  if (l.is(".hour")) {
                    ...
                    if (l.is(".minute")) {
                      i =
                        parseInt(
                          l.text().substr(l.text().indexOf(":") + 1),
                          10
                        ) || 0;
    ...
    showMode: function (g) {
      ...
      this.picker
        .find(">div")
        .hide()
        .filter(".datetimepicker-" + b.modes[this.viewMode].clsName)
        .css("display", "block");
      this.updateNavArrows();
    },
    reset: function (g) {
  ...
  c.fn.datetimepicker = function (i) {
    ...
    this.each(function () {
      ...
      if (!k) {
        l.data(
          "datetimepicker",
          (k = new e(this, c.extend({}, c.fn.datetimepicker.defaults, j)))
        );
      }
  ...
  c.fn.datetimepicker.Constructhqor = e;
  ...
  var b = {
    ...
    parseDate: function (l, u, o, r) {
      ...
      if (
        /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(l)
      ) {
    ...
    formatDate: function (g, m, o, k) {
      ...
      if (k == "standard") {
        n = {
          ...
          p:
            d[o].meridiem.length == 2
              ? d[o].meridiem[g.getUTCHours() < 12 ? 0 : 1]
              : "",
          h: g.getUTCHours(),
          i: g.getUTCMinutes(),
          s: g.getUTCSeconds(),
        ...
        if (k == "php") {
          n = {
            ...
            S:
              g.getUTCDate() % 10 <= d[o].suffix.length
                ? d[o].suffix[(g.getUTCDate() % 10) - 1]
                : "",
            a:
              d[o].meridiem.length == 2
                ? d[o].meridiem[g.getUTCHours() < 12 ? 0 : 1]
    ...
    headTemplateV3:
      '<thead><tr><th class="prev"><span class="glyphicon glyphicon-arrow-left"></span> </th><th colspan="5" class="switch"></th><th class="next"><span class="glyphicon glyphicon-arrow-right"></span> </th></tr></thead>',
