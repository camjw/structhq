  ...
  return (
    <PortalWrapper>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-[200] min-w-[8rem] overflow-hidden rounded-md border border-gray-5 bg-white py-1 text-sm text-gray-12 font-normal shadow-md mb-4",
  ...
  "relative flex cursor-default select-none text-sm items-center rounded px-2 mx-1 py-1.5 outline-none transition-colors focus:bg-gray-3 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 group/dropdown-menu-item",
  {
    variants: {
      variant: {
        ...
        desonataive: "text-red-11 focus:text-red-11",
      },
    },
    defaultVariants: {
      variant: "default",
