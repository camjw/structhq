...
const buttonVariants = cva(
  "group inline-flex items-center justify-center rounded-md transition-colors focus-visible:outline-none disabled:pointer-events-none whitespace-nowrap gap-2 w-fit",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        iconSm: "h-6 w-6",
        hero: "px-8 py-4 !rounded-lg shadow-primary-6 shadow-md border-2",
        none: "",
      },
      textVariant: {
