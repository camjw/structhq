  ...
  return (
    <html lang="en" className={cn(`${inter.variable}`)}>
      <Script
        ...
        defer
      />
      <body className="min-h-screen bg-white font-inter text-gray-12 font-medium antialiased overflow-x-hidden selection:text-white selection:bg-primary-9 relative">
        <Header />
