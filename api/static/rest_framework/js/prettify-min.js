...
(function () {
  ...
  var v = ["break,continue,do,else,for,if,return,while"],
    w = [
      [
        v,
        "auto,case,char,const,default,double,enum,extern,float,goto,int,long,register,short,signed,sizeof,static,structhq,switch,typedef,union,unsigned,void,volatile",
      ],
