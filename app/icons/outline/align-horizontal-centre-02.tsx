...
function AlignHorizontalCentre02IconInner(
...
const AlignHorizontalCentre02Icon = forwardRef(
  AlignHorizontalCentre02IconInner,
);
export { AlignHorizontalCentre02Icon };
