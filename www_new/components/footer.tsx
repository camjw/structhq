  ...
  return (
    <footer className="bg-white flex flex-col justify-center items-center lg:px-6 py-8 z-[2] relative">
      <div className="container flex flex-col md:flex-row-reverse gap-12 py-6 md:gap-20 md:py-14 md:justify-between border-t border-gray-4">
        ...
        <div className="flex flex-col gap-6 items-start flex-shrink-0 border-t border-gray-5 pt-8 md:border-0 md:pt-0">
      ...
      <div className="container">
        <div className="border-t border-gray-5 py-8 justify-between flex flex-col-reverse gap-8 lg:flex-row lg:items-center">
