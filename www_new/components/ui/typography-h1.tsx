...
const typographyH1Variants = cva("font-semibold font-poppins", {
  variants: {
    size: {
      default: "text-2xl sm:text-4xl !leading-[133%]",
      blog: "text-3xl xs:text-4xl md:text-[60px] lg:text-6xl tracking-tight !leading-[1.125]",
      lg: "text-4xl xs:text-5xl md:text-[80px] lg:text-7xl tracking-tight !leading-[1.125]",
    },
  },
  defaultVariants: {
    size: "default",
